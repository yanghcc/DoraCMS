...
let TemplateItems = require('./TemplateItems')

let ContentCategorySchema = new Schema({
  _id: {
    type: String,
...
ContentCategorySchema.path('date').get(v => {
  return moment(v).format('YYYY-MM-DD HH:mm:ss')
})

let ContentCategory = mongoose.model('ContentCategory', ContentCategorySchema)

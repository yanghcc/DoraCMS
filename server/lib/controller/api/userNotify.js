...
const { userNotifyService, notifyService } = require('@service')
...
exports.delUserNotify = async (req, res, _next) => {
  try {
...
exports.setMessageHasRead = async (req, res, _next) => {
  try {
    let targetIds = req.query.ids
    let queryObj = {}
    let errMsg = ''
    ...
    await userNotifyService.updateMany(
      res,
      targetIds,
      {
        isRead: true

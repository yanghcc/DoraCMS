const { contentTemplateService, templateItemService } = require('@service')
const formidable = require('formidable')
const { validateForm } = require('../validate/index')

const _ = require('lodash')
const settings = require('@configs/settings')
const { cache, siteFunc, service } = require('@utils')
...
exports._setTempData = (res, targetTemp) => {
  ...
  let newPubPath = siteFunc.setTempParentId(
    service.scanFolder(system_template_forder, targetTemp + '/public'),
    'public'
  )
